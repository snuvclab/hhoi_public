...
def get_config():
    ...
    parser.add_argument('--normalize_data', default=False, action='store_true')
    ...
    parser.add_argument('--regression_head', type=str, default='Rx_Ry_T_S_both')
    ...
    parser.add_argument('--human_pose_dim', type=int, default=126)
    parser.add_argument('--model_type', type=str, help='one of the [hoi, hhi] in training / hhoi in inference')
    ...
    parser.add_argument('--input_text_prompt', type=str, default='')
    
    """ hhoi testing """
    parser.add_argument('--hoi_score_model_path', type=str, default='', help='score network ckpt path')
    parser.add_argument('--hhi_score_model_path', type=str, default='', help='score network ckpt path')
    parser.add_argument('--input_pickle_path', type=str, default='')
    parser.add_argument('--use_inconsistency_loss', action='store_true')
    parser.add_argument('--use_collision_loss', action='store_true')
    parser.add_argument('--time_thres', type=float, default=0.5)
    parser.add_argument('--use_exact_collision', action='store_true')
    parser.add_argument('--solver_type', type=str, default='gpu', help='gpu | cpu')
    parser.add_argument('--additional_loss_step', type=int, default=1)
    parser.add_argument('--sampling_steps_for_gpu_solver', type=int, default=2)
    
    """ application """
    parser.add_argument('--application_mode', type=str, help='completion | refinement')
    parser.add_argument('--input_path', type=str, help='input path for compeletion, refinement')
